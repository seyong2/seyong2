...
![count_employment_type](https://github.com/seyong2/seyong2.github.io/assets/41242974/1ebee0d4-053a-4469-a3a8-967916789237)
    ...
    - `employee_residence`
The next categorical variable to see is `employee_residence, which tells in which country each data scientists was living during a work year. Although this is categorical, it has 78 different country names available and this makes us difficult to analyze the distribution of this variable. Thus, I came up with an idea of mapping the countries based on geographical location provided by [Unicef Regional Classification](https://data.unicef.org/regionalclassifications/); East Asia and Pacific, Eastern Europe and Central Asia, Western Europe, Latin America and Caribbean, Middle East and North Africa, North America, South Asia, Eastern and Southern Africa, and West and Central Africa. As expected, most of the data scientists resided in North America (Canada and the United States)
